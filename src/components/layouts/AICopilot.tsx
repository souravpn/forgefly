  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: "assistant",
      content:
        "Hi! I'm Freeda, your AI Copilot. I have full awareness of your business, clients, projects, and proposals. Ask me anything or try a quick action below!",
  ...
  const handleAction = async (action: string, actionData: any) => {
    switch (action) {
      ...
      case "open_command_bar":
        toast.info("Use the command bar to update your business OS", {
          duration: 4000,
        });
        break;
