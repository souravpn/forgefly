    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="business">
        ...
        <TabsContent value="client-portal" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-balance">Client Portal Settings</CardTitle>
              <CardDescription>Customize how clients view their projects and invoices</CardDescription>
            </CardHeader>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground text-pretty mb-4">
                      See how your clients experience their dedicated portal with branded project tracking, 
                      invoice management, and proposal approvals.
                    </p>
                    <Button
                      className="glow-accent"
                      onClick={() => navigate('/client-portal')}
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Portal uses your business name from Business Profile settings
                  </p>
                </div>
                ...
                <div className="pt-4 border-t">
                  <p className="text-sm text-muted-foreground text-pretty">
                    💡 <strong>Tip:</strong> Share the client portal link with your clients to give them 
                    24/7 access to their projects, invoices, and proposals. They'll love the transparency!
                  </p>
                </div>
              </div>
            </CardContent>
